<main class="main-content col-lg-8 col-md-12">
    <div class="d-flex justify-content-between align-items-center my-4">
        ...
        <h2 class="text-center m-0">Actualizar información del Usuario</h2>
    </div>
    <form id="formPersona" action="">
        ...
        <div class="form-group">
            ...
            <button type="button" class="btn btn-link" onclick="togglePasswordVisibility()">Mostrar/Ocultar</button>
        </div>
        <div class="form-group">
        ...
        <br>
        <button type="button" class="btn btn-success" onclick="actualizar_persona()">Actualizar Persona</button>
    </form>
</main>

<script src="<?php echo BD_URL ?>views/js/functions_personas.js"></script>
<script>
    const id_u = <?php echo $_GET['id_u'];?>;
    verPersona(id_u);
</script>
